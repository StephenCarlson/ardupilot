...
-- desc
---@param param1 boolean
function motors:set_spoolup_block(param1) end

-- desc
---@return boolean
function motors:get_spoolup_block() end

-- desc
---@param param1 boolean
function motors:armed(param1) end
...
-- desc
---@return boolean
function util:get_soft_armed() end

-- desc
---@param param1 boolean
function util:set_soft_armed(param1) end
...
-- desc
function rcout:enable_channel_mask_updates() end

-- desc
function rcout:disable_channel_mask_updates() end

-- desc
---@param param1 integer
---@param param2 integer
---@param param3 uint32_t_ud
---@param param4 integer
---@param param5 boolean
function rcout:send_dshot_command(param1, param2, param3, param4, param5) end
